...
\begin{figure}[htbp]
  ...
  \caption{Mean-fitness heatmap across generations and tree heights. Each cell aggregates individuals of a given height at a given generation, with warmer colors indicating higher fitness.}
...
Hence the importance of bloat control through selection rather than a hard height limit: it allows the population to explore more complex structures while keeping them in check, rather than outright forbidding them.
% =============================================================================
\section{Conclusion}
