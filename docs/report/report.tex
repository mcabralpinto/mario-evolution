...
\begin{table}[htbp]
\centering
\caption{Pairwise comparisons of key metrics across evolved agents. Covers mean difference \(\Delta\), 95\% confidence interval for \(\Delta\), Cohen's \(d\), and result of a two-tailed Welch's \(t\)-test \(n = 5\)}
\label{tab:pairwise}
\resizebox{\textwidth}{!}{%
