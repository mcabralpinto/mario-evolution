...
class Environment(object):
    ...
    def __init__(self, name='Unnamed agent', host='localhost', port=4242, visualization=False, 
                init_mario_mode=2, level_difficulty=0, level_type=0, creatures_enabled=True, level_seed=1, time_limit=50, fast_tcp=False):
        '''Constructor.
        ...
        self.creatures_enabled = creatures_enabled
        self.init_mario_mode = init_mario_mode
    ...
    def reset(self):
        ...
        self._tcpclient.sendData("reset -maxFPS on "+argstring+"\r\n")
